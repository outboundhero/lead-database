...
const TEST_CORPUS = [
  ...
  ["554 5.7.1 Message rejected due to local policy", "policy"],
  ["550 5.7.1 This message was blocked by the recipient's organization policy", "policy"],
  ["Your message was blocked. Access denied. Prohibited by administrator.", "policy"],
